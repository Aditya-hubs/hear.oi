...
function Astro(){
    useEffect(() => {
        ...
        const initialPosition = path.getPointAtLength(0); // Get the coordinates at the start of the path
        astronaut.setAttribute("transform", `translate(${initialPosition.x}, ${initialPosition.y})`);
    ...
    return(
        <div className="ml-[700px] pt-[50px] mb-[50px]">
  ...
  <g className="astronaut">
    ...
    <path fill="none" stroke="#2D2D2D" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" d="M94.7 53.1c0 6.1-3.4 11.2-10.2 15.5-6.8 4.3-15.1 6.4-24.7 6.4-9.7 0-17.9-2.1-24.7-6.4-6.8-4.3-10.2-9.5-10.2-15.5 0-5.1 2.4-9.6 7.3-13.4h55.5c4.6 3.8 7 8.3 7 13.4z"/>
    <path fill="none" stroke="#E6E6E6" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" d="M83.5 47.6c2.4 3.5 2.4 7.8 0 12.7M35.8 47.6c-2.4 3.5-2.4 7.8 0 12.7"/>
    <path fill="#1668B2" stroke="#EF3D43" strokeMiterlimit="10" strokeWidth="1.439" d="M70.9 95.9c0-4.807 3.893-8.7 8.7-8.7 4.807 0 8.7 3.893 8.7 8.7 0 4.807-3.893 8.7-8.7 8.7a8.698 8.698 0 0 1-8.7-8.7z"/>
...
//     return (
//         <div className="ml-[700px] pt-[50px]">
//             <svg id="motionPath" viewBox="-20 0 557 190">
//                 <path id="path" fill="none" d="M8,102 C15,83 58,25 131,24 206,24 233,63 259,91 292,125 328,155 377,155 464,155 497,97 504,74" />
//                 <g className="astronaut">
//                     <path fill="#CCC" d="M25 127.7h.5v-16.1H4.1c.9 3.7 2.8 6.9 5.6 9.8 4.3 4.2 9.4 6.3 15.3 6.3m69.9 0h.1c5.9 0 11-2.1 15.2-6.3 2.9-2.9 4.7-6.1 5.6-9.8H94.4v16.1h.5M31.8 31.4c-4.3.9-8.1 2.9-11.4 6.2-4.5 4.5-6.7 9.9-6.7 16.2v13.6c3.3-2.1 7.1-3.2 11.3-3.2.9 0 1.7 0 2.6.1-1.5-3.9-2.3-8.2-2.3-12.7 0-7.6 2.2-14.3 6.5-20.2m74.5 36V53.8c0-6.3-2.2-11.7-6.7-16.2-3-3-6.5-5.1-10.4-6l-.2.8c3.9 5.6 5.8 12 5.8 19.2 0 4.2-.7 8.1-2 11.8l.1.8c.7-.1 1.4-.1 2.2-.1 4.1.1 7.8 1.2 11.2 3.3z" />
